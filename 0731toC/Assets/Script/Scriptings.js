...
function setMeOnly():boolean{	//for mutllingual
    ...
    function setMeOnly2():boolean{	//for Promotions
        ...
        function OnGUI () {
            ...
            //print ((Screen.width-Screen.width/4)/2);
             GUI.skin.box.fontSize = Screen.width/40;
             GUI.skin.button.fontSize = Screen.width/40;
             GUI.skin.box.alignment = TextAnchor.MiddleCenter;
             // show message;
               GUI.Box (Rect (((Screen.width-Screen.width/4)/2), (Screen.height/4), (Screen.width/4), (Screen.width/20)), message2show);
                //GUI.Box (Rect (((Screen.width-Screen.width/4)/2), (Screen.height/4), (Screen.width/4), (Screen.width/20)), "将杀,白方胜!");
                if(engineStatus==1) { engineStatus=2; }
		
              //  GUI.Box (Rect (10, 70, 130, 255), "");
                if(GUI.Button (Rect (((Screen.width-Screen.width/4)/2-Screen.width/4), (Screen.height-Screen.width/20*2), (Screen.width/4), (Screen.width/20)), menuArr[lang_flag][2])) TakeBackFlag=true;
                if(GUI.Button (Rect (((Screen.width-Screen.width/4)/2+Screen.width/4), (Screen.height-Screen.width/20*2), (Screen.width/4), (Screen.width/20)), menuArr[lang_flag][1])) NewGameFlag=true;
            ...
            if(alert&&hide) {
                GUI.Box (Rect ((Screen.width-Screen.width/4)/2, (Screen.height-Screen.height/10)/2, Screen.width/4, Screen.width/20), menuArr[lang_flag][20]); 
                if(GUI.Button (Rect ((Screen.width-Screen.width/4)/2, (Screen.height-Screen.height/10)/2+Screen.width/20, Screen.width/4, Screen.width/20), menuArr[lang_flag][25])) {hide=false;}
            }
            if(gameover) {
            //GUI.Box (Rect ((Screen.width-Screen.width/4)/2, (Screen.height-Screen.height/10)/2, Screen.width/4, Screen.width/20), menuArr[lang_flag][20]); 
               // GUI.Box (Rect ((Screen.width-120)/2, (Screen.height-155)/2, 120, 155), "");
                if(GUI.Button (Rect ((Screen.width-Screen.width/4)/2, (Screen.height-Screen.height/10)/2+Screen.width/20, Screen.width/4, Screen.width/20), menuArr[lang_flag][1])) {NewGameFlag=true;}
        ...
        function checkGameover()	{
            if((!gameover) && (engineStatus==0) && (move_animator<4))	{
                if(C0.c0_D_is_check_to_king("w") || C0.c0_D_is_check_to_king("b"))			{
                    message2show = "将+";
                    alert=true;
                    if( C0.c0_D_is_mate_to_king("w") ) {alert=false; message2show = "将杀,黑方胜!"; gameover=true;
                    ...
                    if( C0.c0_D_is_mate_to_king("b") ) {alert=false; message2show = "将杀,白方胜!"; gameover=true;
                    ...
                    { message2show = "此局结束!"; gameover=true; }
                }
            }
            if(mode==2) {
