...
namespace c0_4unity_chessname{
public class c0_4unity_chess : MonoBehaviour {

//     var at2 : int;
//     var c0_is_attack : boolean;
// 	var c0_position="";
// 	var c0_side=1;
// 	var c0_sidemoves=1;
// 	var c0_moving=false;
...
// 	var c0_NAGs="";
    ...
    public int at2;
    public bool c0_is_attack;
	public string c0_position="";
	public int c0_side=1;
	public int c0_sidemoves=1;
	public bool c0_moving=false;
	public bool c0_waitmove=false;
	
	public bool c0_wKingmoved = false;
	public bool c0_bKingmoved = false;
	public bool c0_wLRockmoved = false;
	public bool c0_wRRockmoved = false;
	public bool c0_bLRockmoved = false;
	public bool c0_bRRockmoved = false;
	public bool c0_w00 = false;
	public bool c0_b00 = false;
	
	public int c0_lastmovepawn = 0;
	
	public string c0_become="";
	public string c0_become_from_engine="";			// just engine
	...
	public bool c0_fischer=false;
	public string c0_fischer_cst="";
	
	public bool c0_PG_viewer=true;		// Set true for on-error-prints/ false for silent processing...
   ...
   public  ArrayList c0_PGN_header = new ArrayList(); 
	public bool c0_errflag=false;
...
int charCodeAt(string str, int at) { return System.Convert.ToInt32(str[at]); }
// 	function fromCharCode(cd:int) :String { return (""+System.Convert.ToChar(cd)); }
string fromCharCode(int cd)  { return (""+System.Convert.ToChar(cd)); }
	
// 	function parseInt(nstr:String):int
    int parseInt(string nstr)
// 	{
    {
// 		var rv=0;
        var rv=0;
...
// 	var c0_peka=fromCharCode(34);
    ...
    string c0_peka => fromCharCode(34);
	
// 	function window_confirm(messtxt:String):boolean { return true; }	// No dialogs at the moment...
bool window_confirm(string messtxt) { return true; }	// No dialogs at the moment...
// //----------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
// 			c0_w_00:boolean, c0_bK:boolean, c0_bLR:boolean, c0_bRR:boolean, c0_b_00:boolean, c0_elpas:int, c0_ml:String, c0_s:int ):void
	void c0_set_board_situation( string c0_figlist,bool c0_wK, bool c0_wLR, bool c0_wRR,
...
// //----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	void c0_add_piece(string c0_pstring )
	{
...
// //----------------------------------------------------------------------------------------------------------------------------------------------------------------------
 	void c0_clear_at(string c0_1_at )
 	{
...
// //----------------------------------------------------------------------------------------------------------------------------------------------------------------------
	void c0_just_move_piece(string c0_2_from, string c0_2_to )
	{
		c0_clear_at( c0_2_to );
...
// //-------------------------------------------------
	void c0_moveto(string c0_from_at, string c0_to_at, bool c0_draw)
	{
...
// //-------------------------------------------------
bool c0_D_is_empty(string c0_Zstr)
{
...
//-------------------------------------------------
bool c0_is_empty(int c0_Zvert,int c0_Zhoriz)
{
 var c0_good = true;
...
// //-------------------------------------------------
bool c0_is_enemy(int c0_Zvert,int c0_Zhoriz,string c0_mycolor)
{
...
// //-------------------------------------------------
bool c0_D_is_emptyline(string c0_Zstr1 ,string c0_Zstr2 )
{
...
// //-------------------------------------------------
bool c0_is_emptyline(int c0_Zvert,int c0_Zhoriz,int c0_Zvert2,int c0_Zhoriz2)
{
 var c0_good = true;
...
// //-------------------------------------------------
bool c0_is_check_to_king(string c0_ZKcolor)
{
...
// //-------------------------------------------------
bool c0_is_attacked_king_before_move(string c0_Qfrom_at, string c0_Qto_at, string c0_Qcolor)
{
  c0_is_attack=false;
...
// {
    bool c0_is_mate_to_king(string c0_ZKcolor,bool c0_just_mate)
{
...
// {
    bool c0_is_pate_to_king(string c0_ZWcolor)
{
 var c0_is_pate=true;
...
// {
    bool c0_can_be_moved(string c0_from_at, string c0_to_at, bool c0_just_move_or_eat)
{
  var c0_can = false;
 var c0_vert = parseInt(c0_from_at.Substring(0,1));		
 var c0_horiz= parseInt(c0_from_at.Substring(1,1));
...
// //---------------------------------------
// //
string c0_DCN(string c0_D7from_at,int c0_Dvert_TX, int c0_Dhoriz_TX, int c0_Dcntx)
{
 var c0_D7poss="";
 var c0_c7K="";
...
string c0_ReplaceAll(string Source,string stringToFind,string stringToReplace)
{
  var temp = Source;
...
for( str2=PGN_text;;)
 ...
 var at4 = str2.IndexOf("*");
 if(at4>=0) Result="not finished";
 at4 = str2.IndexOf("1/2");
 if(at4>=0)  Result="1/2-1/2";
 at4 = str2.IndexOf("1-0");
 if(at4>=0)  Result="1:0";
 at4 = str2.IndexOf("1:0");
 if(at4>=0) Result="1:0";
 at4 = str2.IndexOf("0-1");
 if(at4>=0) Result="0:1";
 at4 = str2.IndexOf("0:1");
 if(at4>=0) Result="0:1";
...
string c0_ReplUrl(string str)	// Replaces urls to links...
{
var str2=str;
for(;;)
{
...
string c0_get_moves_from_PGN(string c0_PGN_str)		// Parses PGN moves from string variableown string for chess moves...
{
PGN_text= c0_PGN_str;
...
bool c0_PG_parseString(string str)		// Parses own string for chess moves...
{
var f_error=false;
var gaj=1;
var move="";
...
var i=str.Length;
for(;i>0;i--) if( str.Substring(i-1)!=" " ) break;
...
string c0_get_tag( string str, string tag)
{
 var ret="";
 var ctg1="["+tag+"]";
 var ctg2="[/"+tag+"]";
...
// //-------------------------------------------------
string c0_from_Crafty_standard(string c0_move,string c0_color47)
{
	int c0_i4 = 0;
...
int c0_horiz71;
 if(c0_cp7>=0)
  {
  c0_vert71=parseInt(c0_move.Substring(c0_cp7,1));
 ...
 if(c0_cp7>=0)
  { 
  c0_horiz71=charCodeAt(c0_move.Substring(c0_cp7--,1),0) - 96;
...
for( var c0_i7=0; c0_i7<c0_moveslist.Length;)
  ...
  //if((c0_moveslist.length>c0_i7) && (c0_moveslist.Substring(c0_i7,1)=="[")) c0_i7+=3;
	if((c0_moveslist.Length>c0_i7) && (c0_moveslist.Substring(c0_i7,1)=="[")) c0_i7+=3;
  //c0_mcount7+=0.5;
	c0_mcount7 = (int)((double)c0_mcount7 + 0.5);
	}
	//Debug.Log(c0_mcount7);
...
var c0_i7=0;
var c0_ch7="";
	for(; c0_i7<c0_fen_str.Length; c0_i7++)
	{
		c0_ch7=c0_fen_str.Substring(c0_i7,1);
		if( c0_ch7==" " ) break;
...
// // PGN parser on chess moves
// //----------------------------------
string c0_put_to_PGN(string c0_moves_str)		// To write moveslist to PGN string...
{
...
//? 
for(; c0_i7<c0_PGN_header.Count; c0_i7++)
	{

	var c0_q9  = c0_PGN_header[c0_i7].ToString().ToUpper();
	...
	if( c0_at_q9>=0 )
		{
		Result=c0_PGN_header[c0_i7].ToString().Substring( c0_at_q9 + 7 );
...
// // Crafty notation (quite a standard)
// //-------------------------------------------------
string c0_to_Crafty_standard(string c0_move,string c0_color47)
{
  ...
  if( c0_9color==c0_color47 )
   {
	...
	//?
	var c0_i4=0;
	for(;c0_position.Length>c0_i4; c0_i4+=5)
	{
...
// //------- Get castling settings into variable...
 void  c0_fisch_castl_save(string c0_fen_c,string c0_fen_pos)
{
c0_fischer_cst="";
...
if(atW>=0 && atB>=0)
	...
	for(c0_q8=1; c0_q8<=16; c0_q8++)
		...
		var c0_vt=(c0_q8<9 ? "8" : "1");
		 c0_hz=fromCharCode(96+c0_q8-(c0_q8<9?0:8));
...
// //------- Does fischer movings for castling...
 void c0_fischer_cstl_move(string c0_moving,bool c0_draw)
 {
var c0_king="";
var c0_rook="";
var c0_king2="";
...
string c0_fischer_cst_fCr(string c0_move)
{
var c0_ret8="";
if(c0_fischer)
{
...
string c0_fischer_cst_tCr(string c0_move)
{
var c0_ret8="";
if(c0_fischer)
{
...
void c0_NAGs_define()	// Just data of NAG codes...
{
